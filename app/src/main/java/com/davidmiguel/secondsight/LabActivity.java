...
public class LabActivity extends AppCompatActivity {
    ...
    /**
     * Extracts uri and path values from the intent and sets up an image view that shows the image.
     */
    @Override
    ...
    /**
     * Loads the menu from the resource file.
     */
    @Override
    ...
    /**
     * Calls a helper method for each possible action in the menu.
     */
    @Override
